...
//		userProfilePictureView = (ProfilePictureView) getActivity().findViewById(R.id.userProfilePicture);
//		userNameView = (TextView) getActivity().findViewById(R.id.userName);
//		userLocationView = (TextView) getActivity().findViewById(R.id.userLocation);
//		userGenderView = (TextView) getActivity().findViewById(R.id.userGender);
//		userDateOfBirthView = (TextView) getActivity().findViewById(R.id.userDateOfBirth);
//
