...
public class AddPictureDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.dialog_image_capture, container, false);
        getDialog().requestWindowFeature(Window.FEATURE_NO_TITLE);
        
        int title = getArguments().getInt("title");
        ((TextView) view.findViewById(R.id.tvTitle)).setText(title);
        ((ImageView) view.findViewById(R.id.ivTakePicture)).setOnClickListener(new OnClickListener() {
        ...
        ((ImageView) view.findViewById(R.id.ivSelectPicture)).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                // When button is clicked, call up to owning activity.
    ...
    // Override the Fragment.onAttach() method to instantiate the AddPictureDialogListener
    @Override
